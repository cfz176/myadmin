...
Mock.mock('/captcha', 'get', () => {
    ...
    Result.data = {
        ...
        captchaImg: Random.dataImage('120x30', 'p7n5w')
    }
    return Result
});
...
Mock.mock('/sys/userinfo', 'get', () => {
    ...
    Result.data = {
        id: "1",
        username: "test",
        avatar: "https://img0.baidu.com/it/u=1533706996,3150334193&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"
    }
...
Mock.mock('/sys/menu/nav', 'get', () => {
    ...
    let authorizaties = ['sys:user:list','sys:user:save','sys:user:delete']

    Result.data = {
        nav: nav,
        authorizaties: authorizaties
    };
...
Mock.mock(RegExp('/sys/user/update'), 'post', () => {
    return Result
});
